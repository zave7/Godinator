...
<ul>
	...
	<a href="${pageContext.request.contextPath}/mentor/temp1"><li>멘토hu</li></a>
	<a href="${pageContext.request.contextPath}/mentor/temp2"><li>멘토h</li></a>
	<a href="${pageContext.request.contextPath}/mentor/temp3"><li>멘티2</li></a>
