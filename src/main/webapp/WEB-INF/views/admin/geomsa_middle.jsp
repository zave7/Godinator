...
<div id="contents">
<img src="${root }/resources/images/admin/geomsa.png" style="width: 5px; padding-left: 500px;">
...
<div style="float: right; margin-bottom: 60px;"><button>제출하기</button></div>
</body>
...
<script type="text/javascript">
    ...
    app.$nextTick(function () {
        axios.get('http://inspct.career.go.kr/openapi/test/questions?apikey=76bb04e98de628d1c3711ade67c2344f&q=20').then(function(res){
